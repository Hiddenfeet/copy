import {
  ...
  import { NFT_COLLECTION_ADDRESS, TOKEN_REWARD_ADDRESS, NFT_STAKING_ADDRESS } from "../cost/contractAddresses";
  import { ChainName, swapUrl, tokenExplorer } from "../cost/aLinks";
